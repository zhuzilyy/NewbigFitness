...
//         }
 ...
 // 必须用JSON.parse() 转换一下，才可以显示，否则数据类型会不对
     var option4 = JSON.parse(Android.getPieChartOptions(1003));
          option4=   get1003ColorData(1003,option4);
...
//
    var option5= JSON.parse(Android.getPieChartOptions(1004));
        option5=  get1004ColorData(1004,option5);
...
//        if(Android.get2data1()){
//           document.getElementById('SalesvolumeDiv').visibility == "hidden";
//        }else{
//               document.getElementById('SalesvolumeDiv').visibility == "visible";
//        }
...
function get1003ColorData(type,option){

      var    color=function(params)
             {
                  var colorList = ['#FCA62B','#91d485','#CCA902','#65AF34','#85DCF7', '#FE8463','#9BCA63','#FAD860','#F3A43B','#60C0DD', '#D7504B','#C6E579','#F4E001','#F0805A','#26C0C0'] ;
                  return  colorList[params.dataIndex];
...
function get1004ColorData(type,option){

      var    color=function(params)
             {
                  var colorList = ['#6EBBFF','#95DCF7','#CCA902','#65AF34','#85DCF7', '#FE8463','#9BCA63','#FAD860','#F3A43B','#60C0DD', '#D7504B','#C6E579','#F4E001','#F0805A','#26C0C0'] ;
                  return  colorList[params.dataIndex];
