...
public class MembersAppointmentRecordActivity_ViewBinding<T extends MembersAppointmentRecordActivity> implements Unbinder {
  protected T target;

  private View view2131821155;

  @UiThread
  public MembersAppointmentRecordActivity_ViewBinding(final T target, View source) {
    this.target = target;
