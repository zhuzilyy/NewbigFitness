...
public class ImgVideoListActivity_ViewBinding<T extends ImgVideoListActivity> implements Unbinder {
  protected T target;

  @UiThread
  public ImgVideoListActivity_ViewBinding(T target, View source) {
    this.target = target;
