...
public class EditMebersAppointmentActivityPresenter extends RxPresenter<EditMebersAppointmentActivityContract.View> implements EditMebersAppointmentActivityContract.Presenter {
    ...
    @Inject
    public EditMebersAppointmentActivityPresenter(Api api) {
        this.api = api;
    }
