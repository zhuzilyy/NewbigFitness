package com.example.gufei.bigfitness.com.GuFei.Ui.PopView;
 ...
 * 弹出筛选
 */
public class SexSpinnerPopupWindow    {
    ...
    private  PopupWindowsCallbackInterface popupWindowsCallbackInterface;
    ...
    private SexSpinnerPopupWindow(Builder b) {
        buildPopupWindow(b);
    }
...
//            this.mTitleView.setVisibility(View.VISIBLE);
    ...
    private void initParams(Builder b){
        ...
        mWidth = b.mWidth;
        mHeight = b.mHeight;
        popupWindowsCallbackInterface = b.popupWindowsCallbackInterface;
    }

//   public void  setPopupWindowsCallbackInterface(PopupWindowsCallbackInterface popupWindowsCallbackInterface){
//
//        this.popupWindowsCallbackInterface=popupWindowsCallbackInterface;
//   }
    ...
    private void initPopWindows(){
        ...
        mPopWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                mPopWindow.dismiss();
                popupWindowsCallbackInterface.showCallback("");
...
//        final PopupWindow popupWindow = new PopupWindow(contentView, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, true);
    ...
    public static class Builder {
        ...
        public SexSpinnerPopupWindow build(){
            return new SexSpinnerPopupWindow(this);
        }
        ...
        public Builder setPopupWindowsCallbackInterface(PopupWindowsCallbackInterface popupWindowsCallbackInterface) {
            this.popupWindowsCallbackInterface = popupWindowsCallbackInterface;
            return this;
        }
