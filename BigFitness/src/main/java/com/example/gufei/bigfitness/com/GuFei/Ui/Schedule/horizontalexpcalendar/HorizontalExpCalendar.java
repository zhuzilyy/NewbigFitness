package com.example.gufei.bigfitness.com.GuFei.Ui.Schedule.horizontalexpcalendar;
...
import com.example.gufei.bigfitness.com.GuFei.Ui.Schedule.horizontalexpcalendar.adapter.CalendarAdapter;
import com.example.gufei.bigfitness.com.GuFei.Ui.Schedule.horizontalexpcalendar.common.Animations;
...
import com.example.gufei.bigfitness.com.GuFei.Ui.Schedule.horizontalexpcalendar.common.Utils;
import com.example.gufei.bigfitness.com.GuFei.Ui.Schedule.horizontalexpcalendar.listener.SmallPageChangeListener;
import com.example.gufei.bigfitness.com.GuFei.Ui.Schedule.horizontalexpcalendar.view.page.PageView;


import org.joda.time.DateTime;

import static com.example.gufei.bigfitness.util.TimeUtil.string2Date;
...
//        Marks.refreshCustomMark(new DateTime().plusDays(10), Marks.CustomMarks.CUSTOM2, true);
    ...
    public static void   setcollapse(){
    ...
    public void setTopMarginToAnimContainer(int margin) {
        ((LayoutParams) animateContainer.getLayoutParams()).topMargin = margin;
    }
    ...
    public interface HorizontalExpCalListener {
        ...
        abstract void onChangeViewPager(Config.ViewPagerType viewPagerType);
    }
}