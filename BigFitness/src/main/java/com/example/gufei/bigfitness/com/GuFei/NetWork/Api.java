...
//    );
     ...
     * 添加跟进
     */
//    @GET("appAppointment/saveCustomerContact")
...
//    @FormUrlEncoded
     ...
     * 公海会员详情
     */
    @GET("appPublicsea/getMemberInfoById")
//    @FormUrlEncoded
    rx.Observable<PublicSeaInfoForMemberBean> getPublicseaMemberInfoById(
...
//    @FormUrlEncoded
     ...
     * 批量变更跟进教练
     */
    @GET("appMember/updateLessonMemberOwnTeacherBatch")
//    @FormUrlEncoded
    rx.Observable<CodeBean> updateLessonMemberOwnTeacherBatch(
            @Query("UserId") int UserId,
            @Query("UserName") String UserName,
            @Query("token") String token,
            @Query("ClubId") int ClubId,
     ...
     * 上课详情
     */
    @GET("appLesson/getLessonInfoFromApponitment")
...
//    @FormUrlEncoded
     ...
     * 私教课列表
     */
    @GET("appLesson/getLessonListByMemberIdAndTeatcherId")
     ...
     * 补课列表
     */
    @GET("appAppointment/getMakeUpMemberLessonList")
    rx.Observable<LessonListForMemberBean> getMakeUpMemberLessonList(
            @Query("UserId") int UserId,
            @Query("token") String token,
            @Query("ClubId") int ClubId,
            @Query("MemberId") String MemberId
    ...
    /**私教课详情*/
    @GET("appLesson/getLessonInfoById")
    rx.Observable<PrivateLessonInfoBean> getLessonInfoById(
            @Query("UserName") String UserName  ,
            @Query("UserId") int UserId,
            @Query("token") String token,
            @Query("ClubId") int ClubId,
            @Query("Id") int LessonId
    );

    /**小团体详情*/
    @GET("appLesson/getGroupLessonInfoById")
    rx.Observable<GroupLesssonInfoBean> getGroupLessonInfoById(
            @Query("UserName") String UserName  ,
            @Query("UserId") int UserId,
            @Query("token") String token,
            @Query("ClubId") int ClubId,
...
//    @GET("appAppointment/saveMemberAppiontment")
    @POST("appAppointment/saveMemberAppiontment")
    @FormUrlEncoded
...
//            @Field("UserName") String UserName,
            ...
            @Field("token") String token,
            @Field("ClubId") int ClubId,
            @Field("appointType") String appointType,
            @Field("AppointmentTypeId") String AppointmentTypeId,
            @Field("Content") String Content,
            @Field("MemberId") String MemberId,
            @Field("EndTime") String EndTime,
            @Field("StartTime") String StartTime,
            @Field("Tipinterval") String Tipinterval,
            @Field("Tipstarttime") String Tipstarttime,
            @Field("LessonId") String LessonId,
            @Field("PlanInfo") String PlanInfo,
            @Field("IsMakeUp") String IsMakeUp,
            @Field("AppointmentId") String AppointmentId
    );
...
//    @FormUrlEncoded
     ...
     * 保存会员跟进信息
     */
//    @GET("appMember/insertMemberAppointmentByMemberID")
     ...
     * 取消预约
     */
    @GET("appAppointment/cancelLessonAppointment")
    rx.Observable<CodeBean> getCancelLessonAppointment(
     ...
     * 确认预约
     */
    @GET("appAppointment/confirmLessonAppointment")
    rx.Observable<CodeBean> getConfirmLessonAppointment(
            @Query("AppointmentId") int AppointmentId,
            @Query("token") String token
    );
     ...
     * 下课按钮
     */
    @GET("appMember/memberLesson/DeductionClass")
    rx.Observable<ClassOverBean> getClassOver(
     ...
     */
    @GET("appAppointment/getMakeUpMemberListForContactTeacher")
    rx.Observable<PersonListBean> getMakeUpMemberListForContactTeacher(
            ...
            @Query("personType") String personType,
            @Query("NameOrTel") String NameOrTel,
            @Query("IsMakeUp ") String IsMakeUp
...
//            @Query("Remark") String Remark
    ...
    @GET("appReport/getDayAddCustomerReportForManager")
    rx.Observable<AdddayBean> getDayAddCustomerReportForManager(
            @Query("IsDepartManager") String IsDepartManager,
            @Query("personType") String personType,
            @Query("ClubList") String ClubList,
            @Query("UserLevel") String UserLevel,
...
//            @Query("StartCardCreateTime") String StartCardCreateTime,
//            @Query("EndCardCreateTime") String EndCardCreateTime,
//            @Query("StartLastContactTinme") String StartLastContactTinme,
//            @Query("EndLastContactTime") String EndLastContactTime,
//            @Query("StartExpireTime") String StartExpireTime,
//            @Query("EndExpireTime") String EndExpireTime,
//            @Query("StartLessonCreateTIme") String StartLessonCreateTIme,
