...
public class ScheduleActivityPresenter extends RxPresenter<ScheduleActivityContract.View> implements ScheduleActivityContract.Presenter {
    ...
    @Inject
    public ScheduleActivityPresenter(Api api) {
        this.api = api;
    }
