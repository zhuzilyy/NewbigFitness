...
public class ChartsMainActivityPresenter extends RxPresenter<ChartsMainActivityContract.View> implements ChartsMainActivityContract.Presenter {
    ...
    @Inject
    public ChartsMainActivityPresenter(Api api) {
        this.api = api;
    }
