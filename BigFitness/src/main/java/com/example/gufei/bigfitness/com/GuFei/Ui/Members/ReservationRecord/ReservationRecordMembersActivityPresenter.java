...
public class ReservationRecordMembersActivityPresenter extends RxPresenter<ReservationRecordMembersActivityContract.View> implements ReservationRecordMembersActivityContract.Presenter {
    ...
    @Inject
    public ReservationRecordMembersActivityPresenter(Api api) {
        this.api = api;
    }
