...
public class AppointmentDetailsActivityPresenter extends RxPresenter<AppointmentDetailsActivityContract.View> implements AppointmentDetailsActivityContract.Presenter {
    ...
    @Inject
    public AppointmentDetailsActivityPresenter(Api api) {
        this.api = api;
    }
//
//    @Override
