...
public class ScheduleAddAppointmentActivity extends BaseActivity<ScheduleAddAppointmentActivityPresenter> implements ScheduleAddAppointmentActivityContract.View {
...
//                        Toast.makeText(ScheduleAddAppointmentActivity.this, getDataTime(date), Toast.LENGTH_SHORT).show();
                        break;
                    case TIME_END_ID:
...
//                        Toast.makeText(AddAppointmentActivity.this, getTime(date), Toast.LENGTH_SHORT).show();
    ...
    public void onViewClicked(View view) {
        ...
        final Intent intent = new Intent(ScheduleAddAppointmentActivity.this, FilterListActivity.class);
...
//                        startActivity(intent);
            ...
            case R.id.btn_training_plan:
                ...
                final Intent TrainingPlanAdd = new Intent(ScheduleAddAppointmentActivity.this, TrainingPlanListActivity.class);
