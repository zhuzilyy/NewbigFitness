...
public interface PublicSeaListContract {

    interface View extends BaseView {
        void outLogin();

        void succeed(PublicSeaBean publicSeaBean);
        void succeedEdit(String msg);
        void succeedPubluc(CodeBean codeBean);
        void succeedoperate();
...
//                String order);
        ...
        void appUpdateCustomerPublicSeaType(
                int UserId  ,String UserName  ,String token  ,int ClubId  ,String CustomerId  ,String NewPublicSeaId , String Cause);
