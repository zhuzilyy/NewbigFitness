...
public class LessonInfoPrivateActivityPresenter extends RxPresenter<LessonInfoPrivateActivityContract.View> implements LessonInfoPrivateActivityContract.Presenter {
    ...
    @Inject
    public LessonInfoPrivateActivityPresenter(Api api) {
        this.api = api;
    }
