...
public class CustomerInfoCollectionPresenter extends RxPresenter<CustomerInfoCollectionContract.View> implements CustomerInfoCollectionContract.Presenter {
    ...
    @Inject
    public CustomerInfoCollectionPresenter(Api api) {
        this.api = api;
    }
